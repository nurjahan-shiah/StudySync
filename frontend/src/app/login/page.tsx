  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setError(errorBody?.detail || 'Login failed. Please try again.');
      ...
      localStorage.setItem('ss_token', loginData.access_token);

      localStorage.setItem('ss_user_id', loginData.user_id);

      localStorage.setItem('ss_user_email', loginData.user_email);

      localStorage.setItem('ss_user_role', loginData.user_role);
